...
using IUser = BotModel.Bots.BotTypes.Interfaces.Messages.IUser;
...
namespace BotService.Reflection
{
	public class MapperPropInfo : MapperMemberInfo, IPay
	{
		...
		private void SetValue(object value)
		{
			...
			{
				{ Logger.CreateLogger(nameof(MapperPropInfo)).Warning(ex); }
	...
	public class MapperMethodOnAllMsg : MapperMethodInfo, IPay
	{
		...
		public MapperMethodOnAllMsg(MethodInfo methodInfo,  object instance, List<(Type, Func<IBotMessage, IMessageCommand, object>)> customProperty) : base(methodInfo, instance, customProperty)
		{
	...
	public class MapperMethodInfo : BaseMapperMethodInfo, IPay
	{
		...
		public MapperMethodInfo(MethodInfo methodInfo, object instance, List<(Type, Func<IBotMessage, IMessageCommand, object>)> customProperty) : base(methodInfo, instance, customProperty)
		{
	...
	public abstract class BaseMapperMethodInfo : MapperMemberInfo
	{
		...
		public ILogger Logger = BotModel.Logger.Logger.CreateLogger(nameof(BaseMapperMethodInfo));
