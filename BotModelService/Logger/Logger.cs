...
namespace BotModel.Logger
{
	...
	public class Logger : ILogger
	{
		...
		public void Warning(System.Exception exception) => _file.WriteLine($"{_className} warning:{exception.Message}\n{exception.StackTrace}");
		public void Warning(System.Exception exception, string message) => _file.WriteLine($"{_className} warning:{message}\n{exception.Message}\n{exception.StackTrace}");
		...
		public void Error(System.Exception exception) => _file.WriteLine($"{_className} error:{exception.Message}\n{exception.StackTrace}");
		public void Error(System.Exception exception, string message) => _file.WriteLine($"{_className} error:{message}\n{exception.Message}\n{exception.StackTrace}");
	}
}
